...
class BertMetrics:
    def __init__(self, prefix, config):
        ...
        with open(config.data.train_data_path + prefix + "_data.pkl", 'rb') as f:
            ...
            texts, targets, space_count, p_count, comma_count = pickle.load(f)
    ...
    def get_metrics(self):
        ...
        return self.space_count, self.p_count, self.comma_count
...
class BertTrainDataset(Dataset):
    def __init__(self, prefix, config, is_train=False):
        ...
        with open(config.data.train_data_path + prefix + "_data.pkl", 'rb') as f:
            ...
            texts, targets, _,_,_ = pickle.load(f)
...
def get_datasets_metrics(config):
    ...
    space_count, p_count, comma_count = BertMetrics("train",config).get_metrics()
    ...
    return train_dataset, valid_dataset, space_count, p_count, comma_count
